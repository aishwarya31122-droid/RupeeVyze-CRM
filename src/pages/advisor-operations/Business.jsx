...
function Business() {
  ...
  const advisorLeads = useMemo(() => candidates.filter((candidate) => (candidate.leadType === "Advisor" || candidate.leadType === "Recruitment") && candidate.leadType !== "Insurance Customer" && candidate.workflowStage !== "Dropped"), [candidates]);
