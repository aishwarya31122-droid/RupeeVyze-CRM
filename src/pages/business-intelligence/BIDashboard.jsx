...
export default function BIDashboard() {
  ...
  const metrics = useMemo(() => {
    ...
    const recruitment = candidates.filter((c) => c.leadType === "Advisor Recruitment").length;
    ...
    return {
      ...
      conversionRate,
      activeClients,
      totalLeads: candidates.filter((c) => c.leadType !== "Advisor Recruitment").length
    };
  ...
  const salesFunnel = useMemo(() => {
    const advisorLeads = candidates.filter((c) => c.leadType !== "Advisor Recruitment");
